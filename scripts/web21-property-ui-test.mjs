...
assert.match(kemsHtml, new RegExp(`kems-page\\.js\\?v=${assetVersion}`));
...
assert.match(kemsRuntime, /import\("\.\/agile-page\.js\?v=build1"\)/);
...
assert.doesNotMatch(worker, /web21-agile\.js\?v=build1/);
