...
mustContain("deploy/remote-access-service.mjs", ["const HOST = \"127.0.0.1\"", "4175", "cloudflared", "--token-file", "http://localhost:4173", "mode: 0o600", "0.7.0-alpha7-web.19"]);
...
mustContain("public/remote-access.html", ["Remote access", "Cloudflare Tunnel connector", "http://localhost:4173", "kyle.kems.uk", "Install &amp; connect", "brand-lockup.svg?v=alpha7web19", "page-brand-lockup"]);
mustContain("public/remote-access.js", ["/api/remote-access", "\"/install\"", "\"/action\""]);

console.log("Pi deployment checks passed for Web.19 exact SVG branding, delayed demo and retained loopback Remote Access helper.");
