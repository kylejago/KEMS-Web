...
if (!kemsHtml.includes('src="kems-page.js?v=build1"') || kemsHtml.includes("web21-agile.js")) {
...
if (!serviceWorker.includes("/kems.html") || !serviceWorker.includes("/kems-page.js?v=build1")) throw new Error("PWA canonical KEMS route missing");
