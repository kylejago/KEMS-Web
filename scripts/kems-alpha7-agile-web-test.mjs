...
if (pkg.version !== "0.7.0-alpha7-web.13") throw new Error(`Unexpected package version ${pkg.version}`);
...
if (!index.includes("/agile.html") || !agileHtml.includes("Agile Smart Export")) throw new Error("Agile navigation/page missing");
...
if (!serviceWorker.includes("kems-alpha7-web13-shell-v1") || !serviceWorker.includes("/agile.html")) throw new Error("PWA cache is not Alpha7 Agile aware");
...
console.log("KEMS Alpha7 Web contract passed: versions aligned, Agile read-only parity present, public-site boundary preserved.");
